...
組み込み開発向けのデータ構造・デバイスの抽象化をまとめたライブラリです

## コンポーネント

- [Nano](./Nano/README.md): C/C++ 組み込み開発で便利でかつ広く使えるライブラリをまとめたものです
- `NanoHW`: ハードウェア抽象化 (静的・動的ディスパッチどちらもできます)
- `MbedIF`: `NanoHW` の機能を `MbedOS` のインターフェースで扱えるもの (後方互換性)
- [MbedImpl](./MbedImpl/README.md): MbedOS を用いた NanoHW を満たすクラスを提供するライブラリ
- `StubImpl`: C++ 標準機能を用いた NanoHW を満たすクラスを提供するライブラリ
